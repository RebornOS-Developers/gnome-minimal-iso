...
LOCAL_REPO_DIRECTORY="/usr/local/share/rebornos-labs/gnome-minimal-iso/repo"
ISO_REPO_DIRECTORY="$PROJECT_DIRECTORY"/airootfs/home/rebornos/rebornos-labs/gnome-minimal-iso/repo/
